...
Sub KeysToModify(sRegistryRootToUse, DAT_FILE) 
	...
	If DAT_FILE = DAT_NTUSER Then 'This is for updating HKCU keys
		...
		strRegPathParent01 = "Software\Microsoft\Office\16.0\Outlook\Setup"
		strRegPathParent02 = "Software\Microsoft\Office\16.0\Outlook\AutoDiscover\"
		strRegPathParent03 = "Software\Microsoft\Office\16.0\Outlook\AutoDiscover\RedirectServers"
		 
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\UpdateProfiles", "001610354", "REG_DWORD"
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\SetupOutlookMobileWebPageOpened", "000000001", "REG_DWORD"
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\DeleteVBEToolboxCustomization", "000000000", "REG_DWORD" 
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\RegisterForms", "001610354", "REG_DWORD" 
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\MigratePrefs", "000000001", "REG_DWORD" 
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\ImportSRS", "001610354", "REG_DWORD" 
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\DeleteVBEToolboxCustomization", "000000000", "REG_DWORD"
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\DisableOffice365SimplifiedAccountCreation", "000000001", "REG_DWORD" 				
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent02 & "\ExcludeExplicitO365Endpoint", "000000001", "REG_DWORD"
		...
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\", ""
		SetBinaryRegKeys sRegistryRootToUse, strRegPathParent01, "First-Run","hex:fb,9b,c7,bc,ce,e4,05,44,a4,3b,a4,de,6d,8e,c1,c8"
		' 
		...
		SetBinaryRegKeys sRegistryRootToUse, strRegPathParent03, "autodiscover-s.outlook.com","hex:0,0"
		
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent03 & "\", ""
		SetBinaryRegKeys sRegistryRootToUse, strRegPathParent03, "autodiscover.ccny.cuny.edu","hex:0,0"
		
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent03 & "\", ""
		SetBinaryRegKeys sRegistryRootToUse, strRegPathParent03, "autodiscover-s.partner.outlook.cn","hex:0,0"
		
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent03 & "\", ""
		SetBinaryRegKeys sRegistryRootToUse, strRegPathParent03, "autodiscover-s.outlook.de","hex:0,0"
		
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent03 & "\", ""
		SetBinaryRegKeys sRegistryRootToUse, strRegPathParent03, "autodiscover-s.office365.us","hex:0,0"
		
		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent03 & "\", ""
		SetBinaryRegKeys sRegistryRootToUse, strRegPathParent03, "autodiscover.hotmail.com","hex:0,0"
